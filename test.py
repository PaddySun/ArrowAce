...
# #t = threading.Thread(target=speak_text, args=("Bow moving detected!",))
# #t.start()# 开始新线程
...
#             # if height_diff < 0.1 and n > 3:
#             #     # 执行语音播报
#             #     speak_text(“Aim!")

#             height_diffs.append((N, height_diff))  # 记录帧数和高度差
#             if len(height_diffs) > 500:#限制数据量，避免内存消耗过大
#                 height_diffs.pop(0)
